<template>
  <div>
    ...
    <hr>
    <h5 class="pb-2">
      You did a great job and now we know what phone you should definitely buy - OURS!
    </h5>
    ...
    <div class="d-flex">
      <button class="btn btn-success mr-2" @click="showResult = !showResult">
        {{ showResult ? 'Hide' : 'Show me' }} my answers
      </button>
      <button class="btn btn-danger" @click="startAgain">
        Start again
      </button>
    </div>
